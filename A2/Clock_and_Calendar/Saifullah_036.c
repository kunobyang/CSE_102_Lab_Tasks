...
First, Given a specific month and year you have to show the calendar of that month.
** You have to create a GUI that will show your calendar.
** You need to provide slots in your GUI so that the user can provide the inputs.
** As the second part of this assignment, you have to show a clock that will display the current time.
** You can show the clock using 7-segment displays.
** You have to show hours, minutes and seconds in your clock.
** The time displayed in your clock must change as time passes by.
** You have to implement both the calendar and the clock in the same program.
